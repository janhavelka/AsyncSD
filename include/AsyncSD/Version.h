 ...
 * 
 * Generated: 2026-02-24 22:45:16
 * Git commit: 9632de4 (dirty)
 */
...
static constexpr uint32_t VERSION_CODE = 10201;

/// @brief Build date (YYYY-MM-DD).
static constexpr const char* BUILD_DATE = "2026-02-24";

/// @brief Build time (HH:MM:SS).
static constexpr const char* BUILD_TIME = "22:45:16";

/// @brief Full build timestamp.
static constexpr const char* BUILD_TIMESTAMP = "2026-02-24 22:45:16";

/// @brief Git commit hash (short).
static constexpr const char* GIT_COMMIT = "9632de4";
...
static constexpr const char* VERSION_FULL = "1.2.1 (9632de4, 2026-02-24 22:45:16)";
